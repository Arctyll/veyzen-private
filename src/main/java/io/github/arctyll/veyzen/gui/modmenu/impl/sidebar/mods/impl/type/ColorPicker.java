...
import io.github.arctyll.veyzen.helpers.*;
...
public class ColorPicker extends Settings {
    ...
    public void renderSetting(int mouseX, int mouseY) {
        ...
        Veyzen.INSTANCE.fontHelper.size30.drawString(setting.getName(), button.getPanel().getX() + 20, getYH + 6, color);
        animate.update();
        ...
        Veyzen.INSTANCE.fontHelper.size20.drawString(rgbText, getXW - 45 - Veyzen.INSTANCE.fontHelper.size20.getStringWidth(rgbText), getYH + 9, -1);
