...
package io.github.arctyll.veyzen.helpers.render;

import io.github.arctyll.veyzen.Veyzen;
import io.github.arctyll.veyzen.helpers.ColorHelper;
...
public class Helper2D {
    ...
    public static void drawPicture(int x, int y, int w, int h, int color, String location) {
        ...
        ResourceLocation resourceLocation = new ResourceLocation(Veyzen.modID, location);
        Veyzen.INSTANCE.mc.getTextureManager().bindTexture(resourceLocation);
