...
import io.github.arctyll.veyzen.feature.mod.impl.crosshair.CrosshairMod;
import io.github.arctyll.veyzen.feature.mod.impl.crosshair.LayoutManager;
...
public class CellGrid extends Settings {
    ...
    public void renderSetting(int mouseX, int mouseY) {
        ...
        int width = Veyzen.INSTANCE.fontHelper.size20.getStringWidth(text);
        int x = button.getPanel().getX() + button.getPanel().getW() - 20 - width;
        int y = button.getPanel().getY() + button.getPanel().getH() + getY() + 135;

        Veyzen.INSTANCE.fontHelper.size20.drawString(text, x - 3, y + 6, -1);
