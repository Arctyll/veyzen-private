...
import io.github.arctyll.veyzen.feature.mod.impl.ToggleSneakMod;
        ...
        if (Veyzen.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                Veyzen.INSTANCE.fontHelper.size20.drawString(
                        ...
                        getX() + getW() / 2f - Veyzen.INSTANCE.fontHelper.size20.getStringWidth("Sneak: " + (isSneaking() ? "Toggled" : "Vanilla")) / 2f,
                        getY() + 6,
                        getColor()
                );
            } else {
                ...
                Veyzen.INSTANCE.mc.fontRendererObj.drawString(
                        "Sneak: " + (isSneaking() ? "Toggled" : "Vanilla"),
                        getX() + getW() / 2 - Veyzen.INSTANCE.mc.fontRendererObj.getStringWidth("Sneak: " + (isSneaking() ? "Toggled" : "Vanilla")) / 2,
                        getY() + 6,
                        getColor()
                );
            }
