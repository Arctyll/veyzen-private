...
public class ToggleSprintMod extends Mod {
    ...
    public ToggleSprintMod() {
        ...
        Veyzen.INSTANCE.settingManager.addSetting(new Setting("Keybinding", this, Keyboard.KEY_LCONTROL));
    ...
    public void onDisable(){
        super.onDisable();
        KeyBinding.setKeyBindState(Veyzen.INSTANCE.mc.gameSettings.keyBindSprint.getKeyCode(), false);
    }

    @SubscribeEvent
    public void onTick(TickEvent.PlayerTickEvent e) {
        KeyBinding.setKeyBindState(Veyzen.INSTANCE.mc.gameSettings.keyBindSprint.getKeyCode(), toggled);
    }
