    ...
    public void renderMod(int mouseX, int mouseY) {
        ...
        if (Veyzen.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                FontHelper fontHelper = Veyzen.INSTANCE.fontHelper;

                int value = (int) normalized(Veyzen.INSTANCE.mc.thePlayer.rotationYaw);
                ...
                for (int i = 0; i < 4; i++) {
                    int xFull = (int) ((normalized(Veyzen.INSTANCE.mc.thePlayer.rotationYaw) + i * 90) % 360 + getX() - 86);
                    int xHalf = (int) ((normalized(Veyzen.INSTANCE.mc.thePlayer.rotationYaw) + i * 90) % 360 + getX() - 43);
                ...
                FontRenderer fontHelper = Veyzen.INSTANCE.mc.fontRendererObj;
                ...
                GLHelper.startScissor(getX(), getY(), (int) (getW() * getSize()), (int) (getH() * getSize()));
                for (int i = 0; i < 4; i++) {
                    int xFull = (int) ((normalized(Veyzen.INSTANCE.mc.thePlayer.rotationYaw) + i * 90) % 360 + getX() - 83);
                    int xHalf = (int) ((normalized(Veyzen.INSTANCE.mc.thePlayer.rotationYaw) + i * 90) % 360 + getX() - 40);
