...
public class MotionblurMod extends Mod {
    ...
    public MotionblurMod() {
        ...
        Veyzen.INSTANCE.settingManager.addSetting(new Setting("Amount", this, 10, 6));
    }
        ...
        if (Veyzen.INSTANCE.mc.currentScreen == null) {
            if (event.type == RenderGameOverlayEvent.ElementType.ALL) {
                if (OpenGlHelper.isFramebufferEnabled()) {
                    int width = Veyzen.INSTANCE.mc.getFramebuffer().framebufferWidth;
                    int height = Veyzen.INSTANCE.mc.getFramebuffer().framebufferHeight;
                    ...
                    Veyzen.INSTANCE.mc.getFramebuffer().bindFramebufferTexture();
                    ...
                    Veyzen.INSTANCE.mc.getFramebuffer().bindFramebuffer(true);
    ...
    private float getAmount() {
        return Veyzen.INSTANCE.settingManager.getSettingByModAndName(getName(), "Amount").getCurrentNumber();
    }
}
