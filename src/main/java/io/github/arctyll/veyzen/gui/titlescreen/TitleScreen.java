...
package io.github.arctyll.veyzen.gui.titlescreen;

import io.github.arctyll.veyzen.Veyzen;
import io.github.arctyll.veyzen.gui.titlescreen.buttons.IconButton;
import io.github.arctyll.veyzen.gui.titlescreen.buttons.TextButton;
import io.github.arctyll.veyzen.helpers.font.GlyphPageFontRenderer;
...
public class TitleScreen extends Panorama {
    ...
    private void drawLogo() {
        ...
        fontRenderer.drawString(Veyzen.modName, width / 2f - fontRenderer.getStringWidth(Veyzen.modName) / 2f, height / 2f - 27.5f, -1);
        Helper2D.drawPicture(width / 2 - 30, height / 2 - 78, 60, 60, 0x40ffffff, "veyzenlogo.png");
    }
    ...
    private void drawCopyright() {
        ...
        String text = Veyzen.modName + " Client " + Veyzen.modVersion;
